...
import com.crud.tasks.patterns2.facade.api.ItemDto;
import com.crud.tasks.patterns2.facade.api.OrderDto;
import com.crud.tasks.patterns2.facade.api.OrderFacade;
import com.crud.tasks.patterns2.facade.api.OrderProcessingException;
...
//        System.out.println("Registering new order, ID: " +
//                orderId);
//        if (orderId > 0) {
